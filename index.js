const {
  ...
  const ownerNumber = ['254107065646']
...
const sessdata = config.SESSION_ID.replace("SMILES~", '');
...
const port = process.env.PORT || 9090;
  ...
  try {
    await conn.newsletterFollow("120363297764334618@newsletter");
    console.log("📬 Followed MR SMILE newsletter.");
  } catch (e) {
...
╰══════════════⊷`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('254107065646', '254107065646', '254107065646');
...
if (senderNumber.includes("254107065646") && !isReact) {
